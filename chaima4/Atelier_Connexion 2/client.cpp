...
bool client::Ajouterclient()
{
    ...
    QFile file("C:/Users/chaim_if4qa5x/OneDrive/Bureau/chaima/Atelier_Connexion 2/history.txt");
...
bool client::Modifierclient()
{
    ...
    if (!query.prepare("UPDATE client SET NOM = :NOM, PRENOM = :PRENOM, EMAIL = :EMAIL, DATE_INSCRIPTION = :DATE_INSCRIPTION, AGE = :AGE, SEXE = :SEXE, TELEPHONE = :TELEPHONE, NB_SERVICE_RECU = :NB_SERVICE_RECU, DATE_RECEPTION = :DATE_RECEPTION, DATE_CONSERVATION= :DATE_CONSERVATION  WHERE ID_CL = :ID_CL")) {
