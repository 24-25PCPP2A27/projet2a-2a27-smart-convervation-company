...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label->setGeometry(QRect(16, 40, 41, 20));
        label_2 = new QLabel(groupBox);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(10, 80, 47, 16));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        groupBox->setTitle(QApplication::translate("MainWindow", "Traitement de produit", Q_NULLPTR));
