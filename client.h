...
private:
    ...
    QString TELEPHONE;
    int NB_SERVICE_RECU;
    QDate DATE_RECEPTION;
    QDate DATE_CONSERVATION;

public:
    client();
    client(int ID_CL, QString NOM, QString PRENOM, QString EMAIL, QDate DATE_INSCRIPTION, int AGE, QString SEXE, QString TELEPHONE, int NB_SERVICE_RECU, QDate DATE_RECEPTION, QDate DATE_CONSERVATION)
    {
        this->ID_CL = ID_CL;
        this->NOM = NOM;
        this->PRENOM = PRENOM;
        ...
        this->DATE_CONSERVATION = DATE_CONSERVATION;
    }
    ...
    void setDate_reception(QDate date_reception) { DATE_RECEPTION = date_reception; }
    void setDate_conseration(QDate date_conservation) { DATE_CONSERVATION = date_conservation; }
    ...
    QDate getDate_reception() { return DATE_RECEPTION; }
    QDate getDate_conseration() { return DATE_CONSERVATION; }
    ...
    QSqlQueryModel *Rechercherclient(const QString &text);
     bool recupererClient(const QString &email, client &client);
};
